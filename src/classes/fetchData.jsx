...
export class FetchFood{
    constructor(app_key, app_id) {
        ...
        this.app_id = app_id
        this.url_upc = "https://api.edamam.com/api/food-database/v2/parser?app_id={app_id}&app_key={app_key}&upc={upc}".replace("{app_id}", app_id).replace("{app_key}", app_key);
        this.url_ingr = "https://api.edamam.com/api/food-database/v2/parser?app_id={app_id}&app_key={app_key}&ingr={ingr}".replace("{app_id}", app_id).replace("{app_key}", app_key);
    }
